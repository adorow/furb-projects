// Note: This class was in the source code, but wasn't being used, also it made references to files I couldn't find, and was using a library (JautOGL) which I could no longer find online.
