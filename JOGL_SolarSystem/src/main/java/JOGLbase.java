...
//            animator.setRunAsFastAsPossible(false);
    ...
    public void init() {
        setFocusable(true);
        if (hideCursor) {
            inputDevice.hideCursor(this);
        } else {
            inputDevice.setStandardCursor(this);
        }
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        // GL2.GL_FRONT[_AND_BACK], GL2.GL_LINE, GL2.GL_FILL
        gl.glPolygonMode(GL2.GL_FRONT_AND_BACK, GL2.GL_3D);
    ...
    public void dispose(GLAutoDrawable drawable) {
        System.out.println("dispose(GLAutoDrawable)");
    }
    ...
    int getAndPrintError(GL2 gl) {
        ...
        //String errorStr = glu.gluErrorString( GL2.GL_OUT_OF_MEMORY );
        //System.out.println( errorStr );
        //errorStr = gl.glGetString(GL2.GL_PROGRAM_ERROR_STRING_ARB);
